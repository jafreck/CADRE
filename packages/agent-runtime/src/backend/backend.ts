...
import { spawnProcess, stripVSCodeEnv, trackProcess, type ProcessResult } from '@cadre/command-diagnostics';
...
export function isCopilotCliInvocationError(stderr: string): boolean {
