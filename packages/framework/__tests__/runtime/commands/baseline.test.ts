...
import type { ProcessResult } from '../../../src/runtime/commands/exec.js';

vi.mock('../../../src/runtime/commands/exec.js', () => ({
  execShell: vi.fn(),
}));

vi.mock('../../../src/runtime/commands/parse-failures.js', () => ({
  extractFailures: vi.fn(),
}));

import { execShell } from '../../../src/runtime/commands/exec.js';
import { extractFailures } from '../../../src/runtime/commands/parse-failures.js';
import { captureBaseline, baselineResultsSchema } from '../../../src/runtime/commands/baseline.js';
