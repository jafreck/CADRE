...
import type { PreRunValidator, ValidationResult } from '../../../src/core/validation/types.js';
import { PreRunValidationSuite } from '../../../src/core/validation/suite.js';

const makeConfig = () => ({ projectName: 'test' });
