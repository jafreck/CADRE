...
import { PhaseRegistry as CorePhaseRegistry, buildRegistry as buildCoreRegistry } from '../../../../src/core/pipeline/phase-registry.js';
...
describe('pipeline-engine runtime integration path', () => {
  ...
  it('core wrappers should avoid packages/pipeline-engine/src path leaks', () => {
    const coreFiles = [
      '../../../../src/core/pipeline/phase-executor.ts',
      '../../../../src/core/pipeline/phase-gate.ts',
      '../../../../src/core/pipeline/phase-registry.ts',
    ];
